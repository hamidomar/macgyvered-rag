...
@tool
def calc_ltv(loan_amount: float, property_value: float, gse: str = "fnma") -> str:
...
@tool
def calc_w2_income(gross_monthly: float, pay_frequency: str, gse: str = "fnma") -> str:
...
@tool
def calc_pmi_savings(current_pmi_monthly: float, years_remaining: float, gse: str = "fnma") -> str:
...
@tool
def calc_se_income(yr1_net: float, yr2_net: float, depreciation: float, depletion: float, gse: str = "fnma") -> str:
