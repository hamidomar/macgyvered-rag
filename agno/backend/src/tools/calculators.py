...
def calc_ltv(loan_amount: float, property_value: float, gse: str = "fnma", agent=None, run_context=None) -> str:
    ...
    _record_calculation(
        "calc_ltv",
        {"loan_amount": loan_amount, "property_value": property_value, "gse": gse},
        result,
        "ltv_result",
        agent=agent,
...
def calc_w2_income(gross_monthly: float, pay_frequency: str, gse: str = "fnma", agent=None, run_context=None) -> str:
    ...
    # TODO: validate against FNMA B3-3.1-01 for edge cases
...
def calc_pmi_savings(current_pmi_monthly: float, years_remaining: float, gse: str = "fnma", agent=None, run_context=None) -> str:
    ...
    _record_calculation(
        "calc_pmi_savings",
        {"current_pmi_monthly": current_pmi_monthly, "years_remaining": years_remaining, "gse": gse},
        result,
        "pmi_result",
        agent=agent,
        run_context=run_context,
...
def calc_se_income(
    ...
    # TODO: implement full logic per B3-3.3-03 (FNMA)
