...
const Sessions = () => {
  ...
  const [turboRefiSessionId] = useQueryState('refi_session')
  ...
  const { listSessions } = useTurboRefiSession()
  ...
  useEffect(() => {
    ...
    if (isTurboRefiSelected) {
      setSessionsData([])
      void listSessions().catch(() => setSessionsData([]))
      return
    }
  ...
  useEffect(() => {
    if (isTurboRefiSelected) {
      setSelectedSessionId(turboRefiSessionId)
      return
    }
    if (sessionId) setSelectedSessionId(sessionId)
  }, [isTurboRefiSelected, sessionId, turboRefiSessionId])
